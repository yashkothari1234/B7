...
export default class RecieverDetailsScreen extends Component{
  constructor(props){
    super(props);
    this.state={
      value : this.props.navigation.getParam('details')["amount"],
      ...
      <View style={styles.container}>
        ...
        <View style={{flex:0.3}}>
          <Card
            ...
            <Card>
              <Text style={{fontWeight:'bold', fontFamily :'TimesNewRoman'}}>Description : {this.state.reason_for_requesting}</Text>
            </Card>
        ...
        <View style={{flex:0.3}}>
          <Card
            ...
            <Card>
              <Text style={{fontWeight:'bold', fontFamily :'TimesNewRoman'}}>Value : {this.state.value}</Text>
            </Card>
          </Card>
        </View>
